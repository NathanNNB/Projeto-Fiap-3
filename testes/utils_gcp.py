...
def salvar_em_bucket(df: pd.DataFrame, bucket_name: str, blob_name: str):
    ...
    client = storage.Client().from_service_account_json(r'C:\Users\willb\Documents\Projetos\Projeto-Fiap-3\fiap-3-98eeb2f3a5d2.json')
...
def carregar_csv_para_bigquery(project_id: str, dataset_id: str, table_name: str, bucket_name: str, blob_name: str):
    ...
    client = bigquery.Client(project=project_id).from_service_account_json(r'C:\Users\willb\Documents\Projetos\Projeto-Fiap-3\fiap-3-98eeb2f3a5d2.json')
